...
import io
from huskylib import HuskyLensLibrary  # Import the HuskyLens library
    ...
    def navigate(self):
        ...
        while self.navigating:
            try:
                ...
                # --- HuskyLens STOP condition ---
                if self.hl:
                    tracking_status = track(self.hl)
...
if __name__ == '__main__':
    ...
    # HuskyLens setup
    hl = HuskyLensLibrary("SERIAL", "/dev/ttyAMA1")  # Replace with correct port
