...
class Robot:
    ...
    def navigate(self):
        ...
        If no tag is detected, it does LiDAR-based obstacle avoidance + SLAM.
        """
        while self.navigating:
            # 1) Check HuskyLens first
            ...
            # 2) If not tracking, use obstacle avoidance
    ...
    def track_once(self):
        ...
        if -10 < offset < 10:
            ...
            # Turn in place or set differential speed
